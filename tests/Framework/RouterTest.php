...
class RouterTest extends TestCase
{
    ...
    {
        $request = new ServerRequest('GET','/blog');
        $this->router->get('/blogz',function (){return 'hello';},'blosg');
        $route = $this->router->match($request);
    ...
    public function testGetMethodWithParameters()
    {
        ...
        $this->router->get('/blog',function (){return 'aza';},'posts');
        ...
        // test invalid route
        $route = $this->router->match(new ServerRequest('GET','blog/mon_-slug-8'));
        $this->assertEquals(null,$route);
    }
    ...
    public function testGenerateUriWihParams()
    {
        $this->router->get('/blog',function (){return 'aza';},'posts');
        $this->router->get('/blog/{slug:[a-z0-9\-]+}-{id:\d+}',function (){return 'hello';},'post.show');
